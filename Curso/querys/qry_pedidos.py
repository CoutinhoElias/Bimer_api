...
class PedidosDeCompra:
    def __init__(self, cd_empresa, codigo_crm, id_fornecedor, status, dt_emissao_ini, dt_emissao_fim):
        """Inicializa a classe PedidosDeCompra com os parâmetros fornecidos"""
    ...
    # Função comentada para consultar o fornecedor via API
    ...
    def _consultar_pedido_de_compra_api(self):
        """Consulta os pedidos de compra na API com base nos parâmetros fornecidos"""
        # Código comentado para obter dados do fornecedor
    ...
    def obter_dataframe_pedidos_de_compra(self):
        """Obtém um DataFrame pandas dos pedidos de compra consultados na API"""
...
# Código comentado para criar uma instância da classe e obter o DataFrame dos pedidos de compra
